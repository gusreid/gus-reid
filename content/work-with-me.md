...
- Tailored movement tasks based on individual needs
- Individualised guidance and feedback
- Progressive adjustments as you improve

{{< button link="https://pay.gocardless.com/billing/static/bank-pay?id=BRF01KCEYR6VMQ9N6V6RCT53CEM4QKYN&initial=%2Fbank-pay" text="Buy Now" >}}
...
- Anyone wanting to move with greater ease and confidence in daily life

This approach combines principles of biomechanics, movement efficiency, and individualised care to help you achieve your personal movement goals, whether that's reducing pain, improving athletic performance, or simply feeling more comfortable in your body.
...
<div class="article__head" style="">
    <img src="/images/Notion workout program.png" alt="image" height="400px" width="400px" style="float: right; margin-left: 15px;">
</div>
...
From there we will *co-create* a programme based on what came up in the call. Programmes may include a combination of *strength*, *mobility*, *rhythm & coordination* and *balance* training. It all depends on your goals and needs. Starting off where you are and gaining in complexity as you progress. 
